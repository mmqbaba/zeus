...
const (
	...
	HEADER_COPY_SOURCE                      = "copy-resources"
	HEADER_COPY_SOURCE_RANGE                = "copy-resources-range"
	HEADER_RANGE                            = "Range"
	...
	HEADER_COPY_SOURCE_VERSION_ID           = "copy-resources-version-id"
	...
	HEADER_COPY_SOURCE_IF_MATCH            = "copy-resources-if-match"
	HEADER_COPY_SOURCE_IF_NONE_MATCH       = "copy-resources-if-none-match"
	HEADER_COPY_SOURCE_IF_MODIFIED_SINCE   = "copy-resources-if-modified-since"
	HEADER_COPY_SOURCE_IF_UNMODIFIED_SINCE = "copy-resources-if-unmodified-since"
	...
	HEADER_SSEC_COPY_SOURCE_ENCRYPTION = "copy-resources-server-side-encryption-customer-algorithm"
	HEADER_SSEC_COPY_SOURCE_KEY        = "copy-resources-server-side-encryption-customer-key"
	HEADER_SSEC_COPY_SOURCE_KEY_MD5    = "copy-resources-server-side-encryption-customer-key-MD5"
