...
func (r *rabbitMQChannel) DeclareExchange(exchange string, kind string) error {
...
func (r *rabbitMQChannel) DeclareDurableExchange(exchange string, kind string) error {
	return r.channel.ExchangeDeclare(
		exchange, // name
		kind,     // kind
		true,     // durable
